...
namespace DentalAssistantXF.Utils
{
    public static class Constants
    {
        ...
        public const string AboutPageCaption = "About";

        public const string OnDashboardPageAppearingMsg = "OnDashboardPageAppearingMsg";
        ...
        public const string OnDashboardDataChangeMsg = "OnDasboardDataChangeMsg";
